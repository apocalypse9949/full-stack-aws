pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.53.116.62:9090/manager/html'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.53.116.62:9090/springapp1"
            echo "✅ Frontend deployed: http://13.53.116.62:9090/frontapp1"
        }
        failure {
